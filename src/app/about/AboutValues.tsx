      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            <span className="neon-text">{t.about.values.title}</span>
          </h2>
        ...
        >
          {t.about.values.items.map((value: { title: string; description: string }, index: number) => (
            <motion.div
              key={value.title}
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-xl font-semibold text-[var(--foreground)] mb-3 group-hover:text-[var(--neon-blue)] transition-colors">
                {value.title}
              </h3>
